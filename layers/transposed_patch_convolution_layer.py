...
import _patchconv_ext._transposed_patch_convolution as transposed_patch_conv
from .layer_utils import _pair


class TransposedPatchConvolutionFunction(torch.autograd.Function):
    ...
    def forward(self, input, weight, bias, kernel_size, stride, padding,
        ...
        return transposed_patch_conv.transposed_patch_conv_forward(
    ...
    def backward(self, grad_output):
        ...
        grad_input, grad_weight, grad_bias = transposed_patch_conv.transposed_patch_conv_backward(
...
class TransposedPatchConvolution(nn.Module):
    ...
    def __init__(
        ...
        super(TransposedPatchConvolution, self).__init__()
    ...
    def forward(self, x):
        return TransposedPatchConvolutionFunction.apply(
