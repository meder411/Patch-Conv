...
import _mapped_convolution_ext._patch_convolution as patch_conv
from .layer_utils import _pair


class PatchConvolutionFunction(torch.autograd.Function):
    ...
    def forward(self, input, weight, bias, kernel_size, stride, padding,
        ...
        return patch_conv.patch_conv_forward(input, weight, bias,
    ...
    def backward(self, grad_output):
        ...
        grad_input, grad_weight, grad_bias = patch_conv.patch_conv_backward(
...
class PatchConvolution(nn.Module):
    ...
    def __init__(
        ...
        super(PatchConvolution, self).__init__()
    ...
    def forward(self, x):
        return PatchConvolutionFunction.apply(x, self.weight, self.bias,
